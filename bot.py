...
app = Client(
        "my_account",
        bot_token=TOKEN,api_hash=API_HASH, api_id=APP_ID
    )
...
i'm Language Translator 
Made using <b> Google translte API </b> 
Type any text or sentence you went to translate...                                     """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "👤 Contact Me 👤", url="https://t.me/sami_neg"
                    ),
                    InlineKeyboardButton(
                        "⚜️ My Website ⚜️", url="https://samsonnegash.me/"
                    )
                ],
                 [
                    InlineKeyboardButton(
                        "🌐 Source Code Here 🌐", url="https://github.com/samsonnegash/Python-All-Languages-Translator-Bot"
                    )
                ],
            ]
        )
